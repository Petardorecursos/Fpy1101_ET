...
def guardar_pedido_csv():
    try:
        with open("reportesueldos.csv", mode="w",newline="") as archcsv:
            writer = csv.writer(archcsv)
            writer.writerow(["detalle del pedido"])
            for pedido in pedidos:
                print("datos guardados en: pedidos.csv exitosamente ")
    except IOError:
